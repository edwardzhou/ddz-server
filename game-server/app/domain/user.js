...
var userSchema = new mongoose.Schema({
  ...
  ddzBrokenSavings: {type: mongoose.Schema.Types.ObjectId, ref: 'DdzBrokenSavings'}, // 破产补助信息
...
var __toParams = function(model, excludeAttrs) {
  ...
  if (!!model.ddzBrokenSavings && !!model.ddzBrokenSavings.toParams) {
    transObj.ddzBrokenSavings = model.ddzBrokenSavings.toParams();
  }
